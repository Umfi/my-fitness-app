<template>
  ...
  <ion-content fullscreen>
    ...
    <ion-list>
      <ion-list-header>
        <ion-label>Select muscle groups</ion-label>
      </ion-list-header>
      <ion-item>
        <ion-label>Shoulders</ion-label>
        <ion-checkbox slot="end" v-model="shoulders"></ion-checkbox>
      </ion-item>
      <ion-item>
        <ion-label>Chest</ion-label>
        <ion-checkbox slot="end" v-model="chest"></ion-checkbox>
      </ion-item>
      <ion-item>
        <ion-label>Back</ion-label>
        <ion-checkbox slot="end" v-model="back"></ion-checkbox>
      </ion-item>
      <ion-item>
        <ion-label>Arms</ion-label>
        <ion-checkbox slot="end" v-model="arms"></ion-checkbox>
      </ion-item>
      <ion-item>
        <ion-label>Abs</ion-label>
        <ion-checkbox slot="end" v-model="abs"></ion-checkbox>
      </ion-item>
      <ion-item>
        <ion-label>Legs</ion-label>
        <ion-checkbox slot="end" v-model="legs"></ion-checkbox>
      </ion-item>
      <ion-item>
